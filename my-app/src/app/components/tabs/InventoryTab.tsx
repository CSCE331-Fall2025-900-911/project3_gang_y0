...
export default function InventoryTab() {
  ...
  const [form, setForm] = useState({ item: '', quantity: 0, vendor: '', unit_price: 0 });
  ...
  async function save() {
    ...
    setForm({ item: '', quantity: 0, vendor: '', unit_price: 0 });
    setEditing(null);
    fetchItems();
  }
  ...
  function edit(item: InventoryItem) {
    setEditing(item);
    setForm({ item: item.item, quantity: item.quantity, vendor: item.vendor, unit_price: item.unit_price });
  }
